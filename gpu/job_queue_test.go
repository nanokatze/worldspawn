...
func TestFramesInFlight(t *testing.T) {
	...
	A := NewImage(MakeImageConfig(vk.FORMAT_R32_UINT, []int{4096, 4096}).WithLayers(40), 0)
	B := NewImage(MakeImageConfig(vk.FORMAT_R32_UINT, []int{4096, 4096}).WithLayers(40), 0)
