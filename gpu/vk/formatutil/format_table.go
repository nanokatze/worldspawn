...
var formatTable = map[vk.Format]Description{
	...
	vk.FORMAT_ASTC_3x3x3_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_3X3X3,
		BlockSize:   16,
		BlockExtent: [3]int{3, 3, 3},
	},
	vk.FORMAT_ASTC_3x3x3_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_3X3X3,
		BlockSize:   16,
		BlockExtent: [3]int{3, 3, 3},
	},
	vk.FORMAT_ASTC_3x3x3_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_3X3X3,
		BlockSize:   16,
		BlockExtent: [3]int{3, 3, 3},
	},
	vk.FORMAT_ASTC_4x3x3_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X3X3,
		BlockSize:   16,
		BlockExtent: [3]int{4, 3, 3},
	},
	vk.FORMAT_ASTC_4x3x3_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X3X3,
		BlockSize:   16,
		BlockExtent: [3]int{4, 3, 3},
	},
	vk.FORMAT_ASTC_4x3x3_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X3X3,
		BlockSize:   16,
		BlockExtent: [3]int{4, 3, 3},
	},
	vk.FORMAT_ASTC_4x4x3_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X4X3,
		BlockSize:   16,
		BlockExtent: [3]int{4, 4, 3},
	},
	vk.FORMAT_ASTC_4x4x3_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X4X3,
		BlockSize:   16,
		BlockExtent: [3]int{4, 4, 3},
	},
	vk.FORMAT_ASTC_4x4x3_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X4X3,
		BlockSize:   16,
		BlockExtent: [3]int{4, 4, 3},
	},
	vk.FORMAT_ASTC_4x4x4_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X4X4,
		BlockSize:   16,
		BlockExtent: [3]int{4, 4, 4},
	},
	vk.FORMAT_ASTC_4x4x4_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X4X4,
		BlockSize:   16,
		BlockExtent: [3]int{4, 4, 4},
	},
	vk.FORMAT_ASTC_4x4x4_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_4X4X4,
		BlockSize:   16,
		BlockExtent: [3]int{4, 4, 4},
	},
	vk.FORMAT_ASTC_5x4x4_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X4X4,
		BlockSize:   16,
		BlockExtent: [3]int{5, 4, 4},
	},
	vk.FORMAT_ASTC_5x4x4_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X4X4,
		BlockSize:   16,
		BlockExtent: [3]int{5, 4, 4},
	},
	vk.FORMAT_ASTC_5x4x4_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X4X4,
		BlockSize:   16,
		BlockExtent: [3]int{5, 4, 4},
	},
	vk.FORMAT_ASTC_5x5x4_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X5X4,
		BlockSize:   16,
		BlockExtent: [3]int{5, 5, 4},
	},
	vk.FORMAT_ASTC_5x5x4_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X5X4,
		BlockSize:   16,
		BlockExtent: [3]int{5, 5, 4},
	},
	vk.FORMAT_ASTC_5x5x4_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X5X4,
		BlockSize:   16,
		BlockExtent: [3]int{5, 5, 4},
	},
	vk.FORMAT_ASTC_5x5x5_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X5X5,
		BlockSize:   16,
		BlockExtent: [3]int{5, 5, 5},
	},
	vk.FORMAT_ASTC_5x5x5_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X5X5,
		BlockSize:   16,
		BlockExtent: [3]int{5, 5, 5},
	},
	vk.FORMAT_ASTC_5x5x5_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_5X5X5,
		BlockSize:   16,
		BlockExtent: [3]int{5, 5, 5},
	},
	vk.FORMAT_ASTC_6x5x5_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X5X5,
		BlockSize:   16,
		BlockExtent: [3]int{6, 5, 5},
	},
	vk.FORMAT_ASTC_6x5x5_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X5X5,
		BlockSize:   16,
		BlockExtent: [3]int{6, 5, 5},
	},
	vk.FORMAT_ASTC_6x5x5_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X5X5,
		BlockSize:   16,
		BlockExtent: [3]int{6, 5, 5},
	},
	vk.FORMAT_ASTC_6x6x5_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X6X5,
		BlockSize:   16,
		BlockExtent: [3]int{6, 6, 5},
	},
	vk.FORMAT_ASTC_6x6x5_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X6X5,
		BlockSize:   16,
		BlockExtent: [3]int{6, 6, 5},
	},
	vk.FORMAT_ASTC_6x6x5_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X6X5,
		BlockSize:   16,
		BlockExtent: [3]int{6, 6, 5},
	},
	vk.FORMAT_ASTC_6x6x6_UNORM_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X6X6,
		BlockSize:   16,
		BlockExtent: [3]int{6, 6, 6},
	},
	vk.FORMAT_ASTC_6x6x6_SRGB_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X6X6,
		BlockSize:   16,
		BlockExtent: [3]int{6, 6, 6},
	},
	vk.FORMAT_ASTC_6x6x6_SFLOAT_BLOCK_EXT: {
		Class:       CLASS_ASTC_6X6X6,
		BlockSize:   16,
		BlockExtent: [3]int{6, 6, 6},
	},
	...
	vk.FORMAT_R16_SFLOAT_FPENCODING_BFLOAT16_ARM: {
		Class:       CLASS_16BIT,
		BlockSize:   2,
		BlockExtent: [3]int{1, 1, 1},
	},
	vk.FORMAT_R8_SFLOAT_FPENCODING_FLOAT8E4M3_ARM: {
		Class:       CLASS_8BIT,
		BlockSize:   1,
		BlockExtent: [3]int{1, 1, 1},
	},
	vk.FORMAT_R8_SFLOAT_FPENCODING_FLOAT8E5M2_ARM: {
		Class:       CLASS_8BIT,
		BlockSize:   1,
		BlockExtent: [3]int{1, 1, 1},
	},
